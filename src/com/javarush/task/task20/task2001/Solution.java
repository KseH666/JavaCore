...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = new File(args[0]);
//                    .createTempFile("your_file_name", null);
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String isAss = assets.isEmpty() ? "no" : "yes";
            writer.println(isAss);
            writer.flush();
            if (!assets.isEmpty()) {
